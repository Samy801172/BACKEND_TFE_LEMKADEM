...
const app_module_1 = require("../src/feature/root/app.module");
const typeorm_1 = require("@nestjs/typeorm");
const message_entity_1 = require("../src/model/Message/entities/message.entity");
const user_entity_1 = require("../src/model/User/entities/user.entity");
...
describe('MessageController (e2e)', () => {
    ...
    beforeAll(async () => {
        ...
        messageRepository = moduleFixture.get((0, typeorm_1.getRepositoryToken)(message_entity_1.Message));
