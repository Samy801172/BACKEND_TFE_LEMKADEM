...
export class UserService {
  ...
  async addContact(userId: string, contactId: string, message?: string) {
    // Ici tu peux ajouter la logique pour enregistrer la demande dans une table "contacts" ou "invitations"
    // Exemple : await this.contactRepository.save({ from: userId, to: contactId, message });
    // Pour l'instant, on retourne juste un message de succès (mock)
    return {
      success: true,
